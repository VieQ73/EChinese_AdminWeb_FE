...
interface RemoveActionFormProps {
    data: FormData;
...
const RemoveActionForm: React.FC<RemoveActionFormProps> = ({ data, onChange, rules, isSelfAction }) => {
    ...
    if (isSelfAction) {
        return <p>Bạn có chắc chắn muốn gỡ nội dung này không?</p>;
    }
        ...
        <div className="space-y-4">
            <div>
                ...
                <input
                    ...
                    placeholder="Ví dụ: Nội dung spam, Vi phạm quy tắc cộng đồng..."
                />
            ...
            <div>
                ...
                <div className="max-h-32 overflow-y-auto space-y-2 p-2 border border-gray-200 rounded-lg bg-gray-50">
                 ...
                 <p className="text-xs text-gray-500 mt-1">Chọn một hoặc nhiều quy tắc mà nội dung đã vi phạm.</p>
            </div>
             <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <textarea
                    ...
                    rows={2}
                    className="w-full p-2.5 border border-gray-300 rounded-lg bg-gray-50 focus:ring-primary-500 focus:border-primary-500"
                    placeholder="Ví dụ: Gỡ nội dung và gửi cảnh cáo tới người dùng..."
                />
            </div>
            <div>
...
export default RemoveActionForm;
