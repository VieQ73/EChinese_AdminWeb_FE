...
import {
    ...
    MediaIcon, SystemIcon, RuleIcon
} from './components/icons';

// FIX: Add missing BellIcon component and export it.
...
// FIX: Add missing ShieldCheckIcon component to resolve import error.
...
// FIX: Add missing SendIcon component to resolve import error in NotificationsTab.
...
// FIX: Add missing DownloadIcon component to resolve import error.
...
export const NAVIGATION_LINKS: { name: string; path: string; icon: React.FC<IconProps> }[] = [
    ...
    { name: 'Quản lý Media', path: '/media', icon: MediaIcon },
